...
const sub = () => {
  ...
  if(document.getElementById('no1'&&'no2').checked){
  ...
  else if(document.getElementById('no1'&&'no2'&&'no3'&&'yes4').checked){
    toast.success("Sleep problem and locak of mot and bad mood and depressed")
  }
  else{
      // if(document.getElementById('no1'||'no2'||'no3'||'yes4').checked){
        if(document.getElementById('no1' || 'yes2' || 'yes3' || 'no4').checked){
          toast.success("Sleep problem")
        }
        else if(document.getElementById('yes1' || 'no2' || 'yes3' || 'no4').checked){
          toast.success("Lack of motivation")
        }
        else if(document.getElementById('yes1' || 'yes2' || 'no3' || 'no4').checked){
          toast.success("Bad mood")
        }
        else if(document.getElementById('yes1' || 'yes2' || 'yes3' || 'yes4').checked){
  ...
  return (
    ...
    <div>
      ...
      <div className='questions'>
        ...
        <input type="radio" id="yes1" name="1" value="y" onClick={()=>{
          setno1(false)}}/>
        <label for="1">Yes</label>
        <input type="radio" id="no1" name="1" value="n" onClick={()=>{
          setno1(true);
        }}/>
        <label for="1">No</label>
        {no1&&<div className='one'>
        ...
        <input type="radio" id="yes2" name="2" value="y" onClick={()=>{
          setno2(false)}}/>
        <label for="2">Yes</label>
        <input type="radio" id="no2" name="2" value="n" onClick={()=>{
          setno2(true)}}/>
        <label for="2">No</label>
        {no2&&<div className='one'>
        ...
        <input type="radio" id="yes3" name="3" value="y" onClick={()=>{
          setno3(false)}}/>
        <label for="3">Yes</label>
        <input type="radio" id="no3" name="3" value="n" onClick={()=>{
          setno3(true)}}/>
        <label for="3">No</label>
        {no3&&<div className='one'>
        ...
        <input type="radio" id="yes4" name="4" value="y" onClick={()=>{
          setno4(true)}}/>
        <label for="4">Yes</label>
        <input type="radio" id="no4" name="4" value="n"onClick={()=>{
          setno4(false)}}/>
        <label for="4">No</label>
        {no4&&<div className='one'>
          ...
          <input type="radio" id="yes15" name="15" value="y"/>
